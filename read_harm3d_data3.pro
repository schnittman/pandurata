PRO read_harm3d_data3,run_id,aa,L_Ledd
;like read_harm3d_data2, but with no resampling, and only prints rho,
;Te, and L
  N1 = 0
  N2 = 0
  N3 = 0
...
;  aa = 0.0
  attach_NT = 0.
  blnk = 'ABC'
  rdatafile = 'rawdata/RADFLUX_ASCII_012500.dat'
  ...
  dumpstr = string(fix(run_id/10.)*100,format='(I5.5)')
  if (run_id ge 100) then strput,rdatafile,dumpstr,23
;  run_id = run_id+2
  print,rdatafile
  openr,1,rdatafile
  readf,1,blnk
...
;  R_attach = 0.
      ...
      calc_NT_data2,rr,tt,pp,diskbody,sigtau_es,Tdisk,$
        ...
        aa,L_Ledd,M_BH,Mdot_cgs,scale_height,N1,N2,N3,R_attach
      rho_cgs = rho
      Nr2 = 2*N1
      if (Mdotc eq 0.0177) then Nr2 = N1
      r = dblarr(Nr2)
      r(*) = rr(*,N2/2,0)
      N1=Nr2
  endif
